...
-- 插入测试用户
SET @niuzhuang_id = (SELECT id FROM units WHERE name = '牛庄');

INSERT IGNORE INTO users (username, phone, password, role_id, unit_id) VALUES 
('超级管理员', '13800000001', '1', 3, NULL),
('牛庄管理员', '13800000002', '2', 2, @niuzhuang_id),
('牛庄员工', '13800000003', NULL, 1, @niuzhuang_id);
`;
